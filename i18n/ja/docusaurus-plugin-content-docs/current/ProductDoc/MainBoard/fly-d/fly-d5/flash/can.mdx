...
## ファームウェア書き込みモードに入る
    ...
    * 主基板を上位機器にType-Cデータケーブルで接続し、**resetボタンをダブルクリック**すると、主基板のLEDが点滅します。
    :::warning 警告 ::
       * LEDが点滅しない場合、Katapultファームウェアの再焼付けを行ってください：<Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-d/fly-d5/flash/bl#進入dfu燒錄模式">Katapultファームウェアの焼付け</Button>
