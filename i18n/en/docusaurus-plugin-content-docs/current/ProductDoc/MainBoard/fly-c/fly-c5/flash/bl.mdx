...
## Flashing Firmware
    <Tabs>
        <TabItem value="win" label="Windows Flash Tutorial" default>
            ...
            * The bootloader firmware for C8 <Button variant="contained" disableElevation component="a" rel="noopener" href="http://cdn.mellow.klipper.cn/BL/c5.bin">click to automatically download firmware</Button>
