...
## Начало компиляции
    ...
    * Введите следующую команду для начала компиляции (время может занять некоторое)
    ```bash
    make -j4
    ```
        <ImageView image={require('@site/docs/General/dfu-flash/img/make.webp').default} size="50%" align="center" />
    * В конце вывода должно появиться следующее содержимое, что означает успешную компиляцию
