...
* 保存并且重启
 ...
 <ImageView image={require('./img/i2c3.png').default} size="80%" align="center" />


## 接线并且搜索

<ImageView image={require('./img/i2c1.png').default} size="80%" align="center" />
...
<ImageView image={require('./img/i2c2.png').default} size="80%" align="center" />
