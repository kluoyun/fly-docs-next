...
<ImageView image={require('@site/docs/ProductDoc/ExtensionBoard/fly-apls/img/uart.webp').default} 크기="100%" 정렬="중앙" />
...
<ImageView image={require('@site/docs/ProductDoc/ExtensionBoard/fly-apls/img/LED.webp').default} 크기="20%" 정렬="중앙" />
