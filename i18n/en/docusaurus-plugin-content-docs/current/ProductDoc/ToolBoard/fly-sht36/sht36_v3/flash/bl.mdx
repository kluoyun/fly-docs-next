...
## Flash Firmware
    <Tabs>
        <TabItem value="win" label="Windows flashing tutorial" default>
            ...
            * SHT36 V3 firmware download link   <Button variant="contained" disableElevation href="https://cdn.mellow.klipper.cn/firmware/BL/SHT36_V3.zip">Click to download firmware automatically</Button>
