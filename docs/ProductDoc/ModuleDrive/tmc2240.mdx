...
# TMC 2240
    ...
    <ImageView image={require('./img/2240.png').default} size="80%" align="center" />
...
## 主板跳线说明
    ...
    * TMC2240使用UART跳线方法
        <ImageView image={require('./img/2240uart.png').default} size="100%" align="center" />
...
### UART模式参考配置
    ...
    * 如果出现下方报错
        ...
        <ImageView image={require('./img/2240error.png').default} size="80%" align="center" />
