...
Инструкция по прошивке системы FLYOS-FAST: <Button variant="contained" disableElevation component="a" rel="noopener" href="/docs/DebugDoc/flyos-fast/#introduction">инструкция по прошивке системы FLYOS-FAST</Button>
...
## Запись образа
    ...
    <Tabs>
        ...
        <TabItem value="M2WE" label="Через USB запись на M2WE">
            ...
            1. Скачайте драйверы:
               - <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/Utils/zadig-2.7.exe">Драйверы для M2WE</Button>
               - <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/Utils/FLY-BOOT-Setup.msi">Инструмент загрузки BOOT для M2WE</Button>
...
## Запуск верхнего уровня
    ...
    **Ваш верхний уровень уже запущен!**  
    Продолжите выполнение следующего шага: <Button variant="contained" disableElevation component="a" rel="noopener" href="/docs/ProductDoc/SBC/fly-pi-v2/ssh">SSH соединение с верхним уровнем</Button>


## Другие настройки системы

Другие настройки системы см. по ссылке: <Button variant="contained" disableElevation component="a" rel="noopener" href="/docs/DebugDoc/flyos-fast/config">Настройка системы</Button>
