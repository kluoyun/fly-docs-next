...
## Переход в режим записи
    ...
    * Подключите основную плату к хост-компьютеру с помощью Type-C кабеля, затем **дважды нажмите кнопку reset**, при этом на плате должен моргать светодиод.
    :::warning Предупреждение
       * Если светодиод не мигает, повторите запись прошивки Katapult: <Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-d/fly-d5/flash/bl#enter-dfu-flashing-mode">Записать прошивку Katapult</Button>
