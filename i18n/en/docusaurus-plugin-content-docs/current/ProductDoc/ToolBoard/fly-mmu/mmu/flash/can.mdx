...
## Burn Firmware
    ...
    * Please ensure that CAN H and CAN L measure about `60Ω` with a multimeter when powered off, if it is `120Ω` then a `120Ω` jumper needs to be connected, if it is about `40Ω` the jumper needs to be removed
