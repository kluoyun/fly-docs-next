...
## Начало компиляции
    ...
    * Выберите GPIO пины для установки при старте микроконтроллера, введите: !gpio20 Обратите внимание, что восклицательный знак должен быть заглавным
...
## Запись прошивки
    ...
    * Перед записью прошивки подключите инструментальную плату к UTOC или материнской плате с прошивкой моста с помощью провода XT30. Ниже приведен пример соединительной схемы
    ...
    * Убедитесь, что сопротивление между CAN H и CAN L измеряется мультиметром при отключенном питании и составляет около `60 Ом`. Если сопротивление равно `120 Ом`, подключите переходник `120 Ом`; если около `40 Ом`, удалите переходник
