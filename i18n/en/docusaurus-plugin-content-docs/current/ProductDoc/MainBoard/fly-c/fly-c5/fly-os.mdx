...
<Button variant="contained" disableElevation component="a" rel="noopener" href="/docs/DebugDoc/baodian/host/">Host Machine Beginner Guide</Button>

## System Flashing Preparation

- Card reader
- One TF card with a capacity of 16GB-128GB and a transfer speed of Class10 or higher
- Download <Button variant="contained" disableElevation component="a" rel="noopener" href="https://g-ofpa1390.coding.net/public-artifacts/3D-Printers/flyos-fast/packages">H618 system image</Button>
