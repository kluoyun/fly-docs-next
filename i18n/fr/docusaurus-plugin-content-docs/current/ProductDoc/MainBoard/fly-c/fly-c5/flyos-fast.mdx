...
<Button variant="contained" disableElevation href="/docs/DebugDoc/baodian/host/">Guide d’utilisation pour débutants sur la plate-forme supérieure</Button>
...
2. Téléchargez l'image système FLY-C5 : <Button variant="contained" disableElevation href="https://g-ofpa1390.coding.net/public-artifacts/3D-Printers/flyos-fast/packages">Image système H618</Button>
   :::tip
...
10. Étape suivante : <Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-c/fly-c5/ssh">Connexion SSH à la plateforme supérieure</Button>
