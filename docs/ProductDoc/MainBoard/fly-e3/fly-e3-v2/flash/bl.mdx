...
## 烧录固件
    <Tabs>
        <TabItem value="win" label="windows烧录教程" default>
            ...
            * E3的Katapult固件 <Button variant="contained" disableElevation href="https://cdn.mellow.klipper.cn/firmware/BL/E3_V2.hex">点击自动下载固件</Button>
        ...
        <TabItem value="linux" label="上位机烧录教程">
            ...
            * 下方是固件刷写指令
                ```bash
                sudo dfu-util -a 0 -d 0483:df11 --dfuse-address 0x08000000 -D ~/FLY_Katapult/BL/E3/E3_V2.hex
                ```
