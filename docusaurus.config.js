    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          { to: 'https://3dmellow.com/', label: '🎉\xa0Shop\xa0🥳', position: 'left' },
          {
            type: 'search',
            position: 'right',
          },
      ...
      announcementBar: {
        ...
        content: `⏰ <b>Multiple languages are automatically generated by AI, please pay attention to distinguish them. Especially when executing commands and configurations</b> `,
      },
      liveCodeBlock: {
