---
sidebar_position: 3
sidebar_label: Dual X-axis/Index Reference Configuration
---

## slicer starter code provided by Bilibili UP主 muimoon女士:
```bash
...
Copy or mirror macros, need to reference the corresponding code in slicing

* ACTIVATE_COPY_MODE Copy mode
* ACTIVATE_MIRROR_MODE Mirror mode
