...
| 配置项 | 默认值 | 可使用值 | 说明 |
| :---: | :-------: | :--- | :--- |
| `screen` | `hdmi` | <code>nano</code>,<code>{props.screen}</code> <br/> <code>{props.screen1}</code><code>{props.screen2}</code> | 设置屏幕，none则关闭所有显示 |
...
| 配置项 | 默认值 | 可使用值 | 说明 |
| :---: | :-------: | :--- | :--- |
| `shutdown_pin_state` | `0` | `0`, `1` | 设置关机按键的电平状态<br/> 1: 低电平重复<br/> 0: 高电平触发  |
