* `klipper` 서비스가 설치된 상위기기를 사용해야 합니다. <Button variant="contained" disableElevation component="a" rel="noopener" href="/docs/DebugDoc/BasicTutorial/">네트워크를 통해 SSH 연결하기</Button>
