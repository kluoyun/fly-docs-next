...
## Enter Burning Mode
    ...
    * Connect the main board to the host machine using a Type-C data cable, and **double-click the reset button**, at which point the LED on the main board will flash.
    :::warning Warning
       * If there is no flashing LED, please re-flash the Katapult firmware: <Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-d/fly-d5/flash/bl#enter-dfu-burning-mode">Flash Katapult Firmware</Button>
