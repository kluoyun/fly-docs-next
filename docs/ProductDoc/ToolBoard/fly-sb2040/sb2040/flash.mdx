...
## 开始编译           
        ...
        * 选择GPIO pins to set at micro-controller startup，输入：gpio24
        <ImageView image={require('./img/can.png').default} size="80%" align="left" />
...
## 接线
    ...
    <ImageView image={require('@site/docs/ProductDoc/ToolBoard/fly-sb2040/sb2040/img/utoc.png').default} size="100%" align="left" />
