...
## ファームウェアの書き込み
    <Tabs>
        <TabItem value="win" label="STM32F072を使用してWindowsで書き込みチュートリアル" default>
            ...
            * SHT36のKatapultファームウェア <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/firmware/BL/SHT36.zip">ファームウェアを自動ダウンロードするにはここをクリック</Button>
            <WIN />
