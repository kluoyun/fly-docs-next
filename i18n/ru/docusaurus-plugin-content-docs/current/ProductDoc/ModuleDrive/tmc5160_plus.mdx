...
## Справочные настройки материнской платы
    ...
    <Tabs>
        ...
        * Управление светодиодами через расширительный модуль <Button variant="contained" disableElevation href="/docs/DebugDoc/addon/led.mdx">Щелкните для перехода</Button>
