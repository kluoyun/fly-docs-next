...
# 简介
      ...
      Fly_WiScreen是广州镁伦电子科技有限公司Fly3D主板研发团队推出的一款高端Klipper控制屏幕，可通过Wifi和网线两种模式控制3D打印机，支持SD卡和U盘传输打印文件，屏幕响应速度非常快给用户非常好的体验。支持设置主从机模式，进行多机同步操作方便用户管理机器。其中5V供电口可接充电模块用于改装电池方便移动。
