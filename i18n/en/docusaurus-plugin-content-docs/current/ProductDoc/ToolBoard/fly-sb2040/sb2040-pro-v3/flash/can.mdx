...
## Start Compilation
    ...
    * Input `make -j4` to start compilation, it might take some time
...
## Flash Firmware
    ...
    * Before flashing the firmware, connect the tool board to UTOC or a motherboard with bridge firmware flashed using an XT30 cable. Below is a reference wiring diagram
    * Please make sure the DIP switches are set correctly
