...
## 烧录固件
    <Tabs>
        <TabItem value="win" label="STM32F072使用windows烧录教程" default>
            ...
            * SHT36的Katapult固件 <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/firmware/BL/SHT36.zip">点击自动下载固件</Button>
            <WIN />
