...
## Flashing Firmware
    <Tabs>
        <TabItem value="win" label="Windows Flash Tutorial" default>
            ...
            * The Katapult firmware for SB2040 PRO V3 <Button variant="contained" disableElevation href="https://cdn.mellow.klipper.cn/firmware/BL/SB2040_PRO_V3.zip">Click to automatically download the firmware</Button>
            <WIN />
