...
## Début de la compilation
    ...
    * Appuyez sur la touche `Q`, une fois la fenêtre **Save configuration** affichée, appuyez à nouveau sur `Y`
    ...
    * Si la sortie finale ressemble à ceci, alors la compilation a réussi :
