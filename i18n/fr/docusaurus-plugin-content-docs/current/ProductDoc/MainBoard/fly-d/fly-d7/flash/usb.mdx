...
## Entrer en mode de programmation
    ...
    * Connectez la carte mère au PC avec un câble Type-C, puis **appuyez deux fois sur le bouton reset**, une LED clignotera alors sur la carte mère.
    :::warning Avertissement
       * Si aucune LED ne clignote, veuillez réessayer la mise à jour du firmware Katapult :<Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-d/fly-d7/flash/bl#entrer-en-mode-de-programmation-dfu">Mise à jour du firmware Katapult</Button>
