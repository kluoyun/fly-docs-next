...
## Переход в режим записи
    ...
    * Подключите основную плату к хост-компьютеру с помощью Type-C кабеля, затем **дважды нажмите кнопку reset**, при этом на материнской плате будут мигать светодиоды.
    :::warning Предупреждение
       * Если светодиоды не мигают, повторите запись прошивки Katapult:<Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-d/fly-d7/flash/bl#вход_в_режим_записи_dfu">Записать прошивку Katapult</Button>
