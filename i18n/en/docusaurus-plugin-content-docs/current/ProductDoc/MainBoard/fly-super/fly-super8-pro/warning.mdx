...
* The motherboard supports external drivers     <Button variant="contained" disableElevation component="a" rel="noopener" href="/docs/ProductDoc/ModuleDrive/servo-drive">Wiring and Configuration Guide</Button>
...
* Due to previous tutorial issues, DFU was used for burning. If you need to update the firmware, you need to <Button variant="contained" disableElevation component="a" rel="noopener" href="/docs/ProductDoc/MainBoard/fly-super/fly-super8-pro/flash/bl">re-burn the BL</Button>
