...
# TMC 5160 Pro V1.5
    ...
    <ImageView image={require('./img/5160pro.png').default} size="80%" align="left" />
...
## 主板FPC安装
        ...
        <ImageView image={require('./img/line.png').default} size="80%" align="left" />

## 12V FAN接线

        <ImageView image={require('./img/5160pro-fan.png').default} size="80%" align="left" />
