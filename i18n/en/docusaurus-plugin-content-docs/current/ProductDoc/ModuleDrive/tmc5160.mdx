...
## Infinite Position Usage Instructions
    ...
    * This driver requires soldering the DIAG pin by yourself, otherwise the infinite position function cannot be used
    ...
    * Configuring `driver_SGT: :` requires you to test a suitable value by yourself
