...
# VORON 0.2 Reference Configuration
...
##***Items to be changed/checked:***
## MCU path                                [mcu] 
## Printer activity range                  xyz's position   
...
gear_ratio:50:10
## Gear ratio (Galileo gear ratio 7.5:1 and comment out this line; BMG is 50:17, output shaft in front, input shaft behind)
microsteps:16
full_steps_per_rotation: 200    
...
#max_extrude_only_distance: 200.0   # Extrusion flow error can be commented out, but it is recommended to re-slice
