...
## Начало компиляции
    ...
    * Нажмите клавишу `Q`, чтобы появилось меню **Save configuration**, затем нажмите `Y`
    ...
    * Если вывод завершения содержит следующие строки, то компиляция выполнена успешно
