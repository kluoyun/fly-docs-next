...
* 或者使用window/上位机重新烧录katapult固件<Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-d/fly-d5/flash/bl#进入dfu烧录模式">烧录katapult固件</Button>
