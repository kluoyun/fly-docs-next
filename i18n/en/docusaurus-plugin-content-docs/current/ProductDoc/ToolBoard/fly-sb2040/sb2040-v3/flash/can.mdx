...
## Flash Firmware
    ...
    * Please ensure that when the power is off, measure the resistance between CAN H and CAN L with a multimeter to be around `60Ω`. If it is `120Ω`, you need to open the `120Ω` DIP switch. If it is around `40Ω`, you need to close the DIP switch
