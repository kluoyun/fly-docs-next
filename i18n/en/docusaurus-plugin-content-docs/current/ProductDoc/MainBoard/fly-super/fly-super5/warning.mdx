...
* Due to tutorial issues, DFU was previously used for burning. If you need to update the firmware, you need to <Button variant="contained" disableElevation component="a" rel="noopener" href="/docs/ProductDoc/MainBoard/fly-super/fly-super8-pro/flash/bl">reburn the BL</Button>
