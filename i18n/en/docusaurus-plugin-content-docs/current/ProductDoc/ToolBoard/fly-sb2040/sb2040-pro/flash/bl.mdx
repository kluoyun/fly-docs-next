...
## Flash Firmware
    <Tabs>
        <TabItem value="win" label="Windows Flash Tutorial" default>
            ...
            * SB2040 PRO's Katapult firmware <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/firmware/BL/SB2040_PRO.zip">Click to download firmware automatically</Button>
