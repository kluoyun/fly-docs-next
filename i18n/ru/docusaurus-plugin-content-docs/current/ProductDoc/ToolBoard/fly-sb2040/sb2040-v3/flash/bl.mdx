...
## Загрузка прошивки
    <Tabs>
        <TabItem value="win" label="Инструкция по загрузке на Windows" default>
            ...
            * Прошивка Katapult для SB2040 V3 <Button variant="contained" disableElevation href="https://cdn.mellow.klipper.cn/firmware/BL/SB2040_V3.zip">Щелкните для автоматической загрузки прошивки</Button>
            <WIN />
