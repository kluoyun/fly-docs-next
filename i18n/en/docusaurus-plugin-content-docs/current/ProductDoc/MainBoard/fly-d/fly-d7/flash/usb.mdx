...
## Enter Burning Mode
    ...
    * Use a Type-C data cable to connect the main board to the host machine, then **double-click the reset button**, at which point the LED on the main board will flash.
    :::warning Warning
       * If there is no flashing LED, please re-flash the Katapult firmware: <Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-d/fly-d7/flash/bl#enter-dfu-burning-mode">Flash Katapult Firmware</Button>
