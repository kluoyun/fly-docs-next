...
Send "SET_PIN PIN=_probe_ready VALUE=1" in the Klipper console, observe the trigger indicator light, adjust the threshold from small to large until the indicator light is not on. Enter the following command:
```cfg
