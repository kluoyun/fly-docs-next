...
2. 下载FLY-H3系统镜像：<Button variant="contained" disableElevation component="a" rel="noopener" href="https://g-ofpa1390.coding.net/public-artifacts/3D-Printers/flyos-fast/packages">H618系统镜像</Button>
    :::tip
