...
:::
    ...
    <Tabs>
        <TabItem value="linux" label="Flashage DFU">
            * Suivez l'image ci-dessous pour brancher le cavalier de saut `boot1``boot1` puis appuyez sur `rst` pour redémarrer la carte mère
            ...
            * Voici la commande pour flasher en mode DFU :
                ...
                ```
            5. Si vous voyez le message ``File downloaded successfully`` indiqué par la flèche, le flashage est réussi
            ...
            Une fois le flashage terminé, retirez le cavalier de saut de la carte mère et appuyez sur `rst` pour redémarrer la carte mère
