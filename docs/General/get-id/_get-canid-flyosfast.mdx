...
:::
    ...
    2. 其中`1d50:606f` 属于本次你要用到的设备。`OpenMoko, Inc. Geschwister Schneider CAN adapter`后缀具有一定参考价值，但不作为判断依据。
    3. 如果接了多个刷了USB桥接CAN的主板或者多个UTOC等，则会出现多个`1d50:606f`设备，这不影响使用
