...
:::
    ...
    * 在接好CAN H和CAN L信号线之后，使用万用表测量CAN H与CAN L，两者之间的阻值应约为60欧姆
    ...
    <ImageView image={require('./img/can7.png').default} size="80%" align="center" />
...
风扇mos不分正反，插稳即可
    ...
    <ImageView image={require('./img/fanmos.png').default} size="80%" align="center" />
...
:::
    ...
    <ImageView image={require('./img/tappng.png').default} size="80%" align="center" />
