...
:::tip
FLY SHT36 V2不支持电源防反接功能！！！在通电前请仔细检查电源接线，切勿接反！！！！否则会损坏SHT36 V2工具板！！！
:::
...
下图为普通热敏和PT1000的接线方法。
    ...
    <ImageView image={require('./img/nozzle_thermistor.png').default} size="80%" align="center" />
...
### 接近开关
    ...
    SHT36 V2不建议使用接近开关，需要自己单独接一根12V或者24V的电源线给接线开关供电。
