...
2. 下载FLY-C5的系统镜像：<Button variant="contained" disableElevation href="https://g-ofpa1390.coding.net/public-artifacts/3D-Printers/flyos-fast/packages">H618系统镜像</Button>
    :::tip
...
10. 下一步：<Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-c/fly-c5/ssh">通过SSH连接上位机</Button>
