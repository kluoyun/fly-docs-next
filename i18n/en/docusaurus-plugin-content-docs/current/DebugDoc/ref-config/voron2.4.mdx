...
##***Items to be changed/checked:***
## MCU path                                [mcu] 
## Printer active range                    xyz's position   
...
## Adjust extruder motor step value        [extruder] 
...
#    ## Update X0 and Y0 to your values after probing (e.g., X157, Y305)
#    ## Z axis limit switch position definition
