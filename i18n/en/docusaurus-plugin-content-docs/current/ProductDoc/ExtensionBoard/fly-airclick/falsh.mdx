...
## Firmware Download
    ...
    * <Button variant="contained" disableElevation component="a" rel="noopener" href="https://g-ofpa1390.coding.net/public-artifacts/3D-Printers/airclick/packages">Firmware Package Download</Button>
...
## Firmware Update
    * The `AirClick` needs to be powered off, and the ESP32 burning port of `AirClick` needs to be connected to the computer according to BOOT.
    ...
    1. Download and unzip the USB burning tool <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/Utils/flash_download_tool_3.9.4.zip">Click to Download</Button>
