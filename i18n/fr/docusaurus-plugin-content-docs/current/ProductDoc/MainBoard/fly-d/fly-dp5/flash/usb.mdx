...
## Début de la compilation
    ...
    * Appuyez sur la touche `Q`, une fenêtre s'affiche avec **Enregistrer la configuration**, appuyez ensuite sur `Y`
    ...
    * Si le message suivant est affiché à la fin, la compilation a réussi
