...
## Flash Firmware
    <Tabs>
        <TabItem value="win" label="Windows flashing tutorial" default>
            ...
            * SB2040 V3 Katapult firmware <Button variant="contained" disableElevation href="https://cdn.mellow.klipper.cn/firmware/BL/SB2040_V3.zip">Click to download firmware automatically</Button>
            <WIN />
