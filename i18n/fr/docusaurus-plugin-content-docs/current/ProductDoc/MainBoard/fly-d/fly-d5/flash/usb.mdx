...
## Entrer en mode de flashage
    ...
    * Connectez la carte mère à l'ordinateur principal avec un câble Type-C, puis **appuyez deux fois sur le bouton reset**, une LED clignotera alors sur la carte mère.
    :::warning Avertissement
       * Si aucune LED ne clignote, rechargez le firmware Katapult : <Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-d/fly-d5/flash/bl#entrée-en-mode-de-flash-dfu">Recharger le firmware Katapult</Button>
