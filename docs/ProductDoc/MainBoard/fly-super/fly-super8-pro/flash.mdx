...
:::warning 注意事项
* Super8 PRO 预刷的是TF卡烧录的BL固件
* 只要烧录过BL后续无需在烧录BL
* Super8 PRO 的BL有两种，分别为Katapult固件与TF卡烧录的BL固件
* 如果有需要可以根据自己选择重新[BL烧录教程](https://mellow-next.klipper.cn/docs/ProductDoc/MainBoard/fly-super/fly-super8-pro/bl)
:::
...
:::danger 须知
* Super8 PRO 预刷的是TF卡烧录的BL固件,如果需要Katapult烧录需要自己刷BL
:::
