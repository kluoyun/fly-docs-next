...
## 工具板使用CAN连接主板
    ...
    * 请注意工具板电源线不是接到CAN口，是接到12V-24v电源线上
    <ImageView image={require('./img/wiring/canbridge.png').default} size="80%" align="center" />
    <ImageView image={require('./img/wiring/120.png').default} size="80%" align="center" />

## 刷主板固件

* 请确保D5主板烧录的固件是`USB桥接CAN固件配置`
[D5烧录固件](/docs/ProductDoc/MainBoard/fly-d/fly-d5/flash.mdx "点击即可跳转") 
