...
## Flash Firmware
    <Tabs>
        <TabItem value="win" label="STM32F072 Windows Flashing Tutorial" default>
            ...
            * SHT36 Katapult firmware <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/firmware/BL/SHT36.zip">Click to download firmware automatically</Button>
            <WIN />
