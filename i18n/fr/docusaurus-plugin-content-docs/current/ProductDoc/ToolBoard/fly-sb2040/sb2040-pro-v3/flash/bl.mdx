...
## Flasher le firmware
    <Tabs>
        <TabItem value="win" label="Tutoriel de flashage pour Windows" default>
            ...
            * Le firmware Katapult pour SB2040 PRO V3 <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/firmware/BL/SB2040_PRO_V3.zip">Cliquez pour télécharger automatiquement le firmware</Button>
            <WIN />
