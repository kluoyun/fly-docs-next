...
## Burn Firmware
    ...
    * Ensure that the resistance of CAN H and CAN L is around `60Ω` using a multimeter in a power-off state, if it is `120Ω`, connect a `120Ω` jumper, if it is around `40Ω`, remove the jumper
