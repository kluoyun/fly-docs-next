...
## 安装G2T
    ...
    * 下方是参考
        <ImageView image={require('./img/rpi.png').default} size="60%" align="left" />
    * 参考接线
...
## 使用板载RS232连接工具版方法
        ...
        <ImageView image={require('./img/rpi1.png').default} size="60%" align="left" />
...
## 板载5VFAN使用
    ...
    * 如果需要树莓派40PIN控制设备需要根据Klipper教程进行安装 <Button variant="contained" disableElevation href="https://www.klipper3d.org/zh/RPi_microcontroller.html?h=rpi">RPi 微控制器</Button>
        
        <ImageView image={require('./img/fan.png').default} size="50%" align="left" />
...
## 屏幕使用方法
    ...
    * Github地址 <Button variant="contained" disableElevation href="https://github.com/kluoyun/FLY-TFT">FLY-TFT</Button>
...
### 2. 系统安装
    ...
    * 注意：树莓派使用的系统内核版本必须大于`5.17.x`, 执行命令`uname -r`查看内核版本
    * 请刷最新镜像比如`mainsailos`，不是升级内核
    * 需要自行安装 <Button variant="contained" disableElevation href="ttps://klipperscreen.readthedocs.io/en/latest/Installation/">KlipperScreen</Button>
...
## 树莓派zero2与zero2W注意事项
        ...
        <ImageView image={require('./img/zero.png').default} size="60%" align="left" />
...
## 屏幕安装
    ...
    <ImageView image={require('./img/tft.png').default} size="60%" align="left" />
