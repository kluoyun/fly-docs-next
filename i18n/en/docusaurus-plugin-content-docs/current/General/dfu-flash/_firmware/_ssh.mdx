* A host machine with the installed `klipper` service is required  <Button variant="contained" disableElevation component="a" rel="noopener" href="/docs/DebugDoc/BasicTutorial/">Connect via SSH over the network</Button>
