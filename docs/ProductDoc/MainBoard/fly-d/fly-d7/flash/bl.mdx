...
## Katapult固件说明
    ...
    :::tip
        * D7的katapult固件采用第三种连接方式：USB连接
        * D7在2024年9月1号出厂已经预刷好Katapult固
    :::
...
## 烧录固件
    <Tabs>
        <TabItem value="win" label="windows烧录教程" default>
            ...
            * D7的Katapult固件 <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/firmware/BL/D.zip">点击自动下载固件</Button>
            <WIN />
