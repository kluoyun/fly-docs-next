...
## Программирование прошивки
    <Tabs>
        <TabItem value="win" label="Инструкция по программированию STM32F072 через Windows" default>
            ...
            * Прошивка для Katapult SHT36 <Button variant="contained" disableElevation href="https://cdn.mellow.klipper.cn/firmware/BL/SHT36.zip">Щёлкните для автоматического скачивания прошивки</Button>
            <WIN />
