...
## Переход в режим прошивки
    ...
    * Подключите материнскую плату к хост-компьютеру с помощью Type-C кабеля, затем **дважды нажмите кнопку reset**, при этом на материнской плате загорится мигающий светодиод.
    :::warning Предупреждение
       * Если светодиод не мигает, повторите прошивку katapult-прошивки: <Button variant="contained" disableElevation href="/docs/ProductDoc/MainBoard/fly-d/fly-d7/flash/bl#enter-dfu-flash-mode">Прошить katapult-прошивку</Button>
