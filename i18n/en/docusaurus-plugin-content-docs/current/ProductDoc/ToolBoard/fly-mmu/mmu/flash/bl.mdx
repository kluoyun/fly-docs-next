...
## Flash Firmware
    <Tabs>
        <TabItem value="win" label="Windows flashing tutorial" default>
            ...
            * MMU's Katapult firmware <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/firmware/BL/MMU.zip">Click to download firmware automatically</Button>
            <WIN />
