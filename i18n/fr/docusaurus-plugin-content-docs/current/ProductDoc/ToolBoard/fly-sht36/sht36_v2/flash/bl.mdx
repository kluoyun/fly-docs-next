...
## 烧录固件
    <Tabs>
        <TabItem value="win" label="STM32F072使用windows烧录教程" default>
            ...
            * SHT36_V2的Katapult固件  <Button variant="contained" disableElevation component="a" rel="noopener" href="https://cdn.mellow.klipper.cn/firmware/BL/SHT36_V2.zip">Cliquez pour télécharger automatiquement le firmware</Button>
