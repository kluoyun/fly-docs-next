...
## Триггер GPIO (только для Klipper)
    ...
    * Прошивка и подключение см. в этом документе <Button variant="contained" disableElevation href="/docs/ProductDoc/ExtensionBoard/fly-airclick/offline-operation-support">Прошивка и подключение</Button>
