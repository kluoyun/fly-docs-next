...
# Klipper参考配置
    ...
    ####################################################################################
    ## FLY-D8 PRO资料网址： https://mellow-next.klipper.cn/docs/category/fly-d8-h723
    ...
    #                             温度监控                               #
    #####################################################################
    [temperature_sensor Fly-D8]     # FLY主板温度（可自行重命名）
    ...
    sensor_pin: PC5                     # 挤出头传感器Pin脚（T_E0）
    ...
    aliases:
        ...
        EXP1_2=PB2,  EXP1_4=PA13,  EXP1_6=PE15, EXP1_8=PA0 , EXP1_10=<5V>,
        # EXP2 header
